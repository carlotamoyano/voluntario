...
int f = gsl_rng_uniform_int(tau,N+1); // Generar un núm aleatorio entre 0 y N-1 para la fila de la matriz
int c =gsl_rng_uniform_int(tau,N+1); // Generar un núm aleatorio entre 0 y N-1 para la columna de la matriz
...
double epsilon = (double) gsl_rng_uniform(tau);
if (epsilon<p){
